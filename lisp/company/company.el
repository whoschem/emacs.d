...
(defface company-preview
  '((t :inherit (company-tooltip-selection company-tooltip)))
...
(defcustom company-backends `(company-semantic
                              company-capf
                              company-files
...
(defcustom company-idle-delay 0.3
...
(defcustom company-tooltip-idle-delay 0.5
...
(defun company--create-lines (selection limit)
  (let ((len company-candidates-length)
    ...
    (let ((selection (or selection 0)))
      ...
      (when (eq company-tooltip-offset-display 'lines)
...
(defun company-pseudo-tooltip-unless-just-one-frontend-with-delay (command)
  "`company-pseudo-tooltip-frontend', but shown after a delay.
