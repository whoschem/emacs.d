...
;; Post-command hook: bail out of macrostep-mode if the user types
;; "C-x C-q" to make the buffer writable again.
...
Enter `macrostep-mode' if it is not already active, making the
