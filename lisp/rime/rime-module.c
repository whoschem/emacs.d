...
emacs_value string_length (emacs_env *env, ptrdiff_t nargs,
                           emacs_value args[], void *data);
emacs_value finalize (emacs_env *env, ptrdiff_t nargs,
                      emacs_value args[], void *data);
emacs_value get_sync_dir (emacs_env *env, ptrdiff_t nargs,
                          emacs_value args[], void *data);
emacs_value sync_user_data (emacs_env *env, ptrdiff_t nargs,
                            emacs_value args[], void *data);
emacs_value start (emacs_env *env, ptrdiff_t nargs,
                   emacs_value args[], void *data);
emacs_value get_option (emacs_env *env, ptrdiff_t nargs,
                        emacs_value *args, void *data);
emacs_value set_option (emacs_env *env, ptrdiff_t nargs,
                        emacs_value *args, void *data);
emacs_value process_key (emacs_env *env, ptrdiff_t nargs,
                         emacs_value *args, void *data);
emacs_value get_context (emacs_env *env, ptrdiff_t nargs,
                         emacs_value *args, void *data);
emacs_value version (emacs_env *env, ptrdiff_t nargs,
                     emacs_value *args, void *data);
emacs_value set_cursor_pos (emacs_env *env, ptrdiff_t nargs,
                            emacs_value *args, void *data);
emacs_value clear_composition (emacs_env *env, ptrdiff_t nargs,
                               emacs_value *args, void *data);
emacs_value get_input (emacs_env *env, ptrdiff_t nargs,
                       emacs_value *args, void *data);
emacs_value get_commit (emacs_env *env, ptrdiff_t nargs,
                        emacs_value *args, void *data);
emacs_value select_schema (emacs_env *env, ptrdiff_t nargs,
                           emacs_value args[], void *data);
emacs_value get_schema_list (emacs_env *env, ptrdiff_t nargs,
                             emacs_value *args, void *data);
...
emacs_value inline_ascii (emacs_env *env, ptrdiff_t nargs,
                          emacs_value *args, void *data);

void emacs_defun (emacs_env *env, EmacsRime *rime, void *cfunc,
                  char *func_name, char *doc, size_t min, size_t max);
...
char *
get_string (emacs_env *env, emacs_value arg)
{
  if (arg == NULL)
    {
      return NULL;
...
void
notification_handler (void *context, RimeSessionId session_id,
...
emacs_value
string_length (emacs_env *env, ptrdiff_t nargs,
               emacs_value args[], void *data)
{
...
emacs_value
sync_user_data (emacs_env *env, ptrdiff_t nargs,
                emacs_value args[], void *data)
{
  EmacsRime *rime = (EmacsRime*) data;
...
emacs_value
set_cursor_pos (emacs_env *env, ptrdiff_t nargs,
                emacs_value *args, void *data)
{
  EmacsRime *rime = (EmacsRime*) data;
...
emacs_value
clear_composition (emacs_env *env, ptrdiff_t nargs,
                   emacs_value *args, void *data)
{
  EmacsRime *rime = (EmacsRime*) data;
...
emacs_value
select_schema (emacs_env *env, ptrdiff_t nargs,
               emacs_value args[], void *data)
{
  EmacsRime *rime = (EmacsRime*) data;
...
emacs_value
get_schema_list (emacs_env *env, ptrdiff_t nargs,
                 emacs_value *args, void *data)
{
  EmacsRime *rime = (EmacsRime*) data;
...
void
emacs_defun (emacs_env *env, EmacsRime *rime, void *cfunc,
             char *func_name, char *doc, size_t min, size_t max)
{
