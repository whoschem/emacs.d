...
;;
;; Copyright (C) 2006-2007, 2013, 2015  Nikolaj Schumacher
;;
;; Author: Nikolaj Schumacher <bugs at nschum de>
...
(defcustom window-numbering-number-alias
  '((1 . "１")
    (2 . "２")
    (3 . "３")
    (4 . "４")
    ...
    (9 . "９")
    (0 . "０"))
  "The window numbering marker displayed in the mode line."
  :group 'window-numbering
...
;; Create interactive functions for keymap
(dotimes (i 10)
...
(defun window-numbering-get-number-string (&optional window)
  (let ((s (alist-get (window-numbering-get-number window)
                      window-numbering-number-alias)))
